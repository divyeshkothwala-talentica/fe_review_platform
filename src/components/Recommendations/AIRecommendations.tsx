...
const AIRecommendations: React.FC = () => {
  ...
  const renderRecommendationCard = (recommendation: Recommendation, index: number) => {
    ...
    return (
      <div key={`${title}-${author}-${index}`} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
        <div className="flex flex-col sm:flex-row gap-4">
          {/* Book Cover Placeholder */}
          <div className="flex-shrink-0">
            <div className="w-24 h-32 sm:w-32 sm:h-40 bg-gray-200 rounded-md flex items-center justify-center">
            ...
            <div className="mb-4">
              ...
              {confidence && (
                <div className="flex items-center mt-1">
                  ...
                  <div className="ml-1 w-16 bg-gray-200 rounded-full h-1">
                    <div
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Please sign in to access AI recommendations.</p>
          <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Personalized book suggestions powered by AI</p>
            </div>
